...
for(let i=0; i<findUser["mytodos"].length; i++) {
 ...
 <div class="todoinnerdiv">
  ...
  <a id="taskassignee1" href="mailto:${findUser["mytodos"][i]["taskassignee"]}"><i class='bx bx-user-circle'></i> Satyam</a>
</div> 
...
if(selectfiltervalue === "Based On Category"){
  ...
  document.getElementById("searchbarfilter").placeholder = "Search Assignee : admin@gmail.com"
